 ...
 * 根据首字母排序联系人
 * */
public class NormalMaterialPinyinComparator implements Comparator<NormalMaterialPrice> {

	@Override
	public int compare(NormalMaterialPrice lhs, NormalMaterialPrice rhs) {
		return sort(lhs, rhs);
	}

	private int sort(NormalMaterialPrice lhs, NormalMaterialPrice rhs) {
		// 获取ascii值
