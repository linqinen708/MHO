 ...
 * */
public class SideBar_A_N extends View {
    ...
    public SideBar_A_N(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SideBar_A_N(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SideBar_A_N(Context context) {
        super(context);  
    }  
