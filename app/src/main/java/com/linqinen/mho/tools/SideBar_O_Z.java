package com.linqinen.mho.tools;
...
/**
 * 根据首字母排序联系人,联系人右边的链接条目
 * */
public class SideBar_O_Z extends View {

	// 触摸事件
    private OnTouchingLetterChangedListener onTouchingLetterChangedListener;
    // 26个字母
    public static String[] A_Z = { "O", "P", "Q", "R", "S", "T", "U", "V",
            "W", "X", "Y", "Z", "#" };
    ...
    public SideBar_O_Z(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SideBar_O_Z(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SideBar_O_Z(Context context) {
        super(context);  
    }  
